  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-8 transition-transform duration-500 group-hover:-translate-y-2">
        <span className="text-[10px] font-black uppercase tracking-[0.4em] text-white/60">Explore</span>
        <h3 className="mt-3 text-2xl font-black uppercase tracking-tighter text-white">{category.name}</h3>
