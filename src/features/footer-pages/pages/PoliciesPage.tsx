...
export default function PoliciesPage() {
  ...
  const policies = [
    ...
    },
    {
      ...
      href: buildLocalizedPath("/terms", lang),
    ...
    },
    {
      ...
      href: buildLocalizedPath("/support-policy", lang),
    ...
    },
    {
      ...
      href: buildLocalizedPath("/size-guide", lang),
  ...
  return (
    <PageLayout>
      ...
      <Breadcrumb className="mb-6" items={[
        { label: t("footerPages.policies.breadcrumb.home"), href: buildLocalizedPath("/", lang) },
