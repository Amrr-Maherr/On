          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10">
              <Button
                ...
                className="h-14 cursor-pointer rounded-none bg-white px-12 text-sm font-bold uppercase tracking-widest text-neutral-950 transition-all duration-300 hover:bg-white/90 active:scale-[0.97]"
              >
